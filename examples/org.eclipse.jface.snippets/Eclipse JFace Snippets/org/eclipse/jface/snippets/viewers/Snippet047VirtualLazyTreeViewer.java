...
public class Snippet047VirtualLazyTreeViewer {
	private class MyContentProvider implements
			ILazyTreeContentProvider<Object, List<IntermediateNode>> {
		private TreeViewer<Object, List<IntermediateNode>> viewer;
		private List<IntermediateNode> elements;

		public MyContentProvider(
				TreeViewer<Object, List<IntermediateNode>> viewer) {
			this.viewer = viewer;
		}
		...
		public void inputChanged(
				Viewer<? extends List<IntermediateNode>> viewer,
				List<IntermediateNode> oldInput, List<IntermediateNode> newInput) {
	...
	public Snippet047VirtualLazyTreeViewer(Shell shell) {
		final TreeViewer<Object, List<IntermediateNode>> v = new TreeViewer<Object, List<IntermediateNode>>(
				shell, SWT.VIRTUAL | SWT.BORDER);
