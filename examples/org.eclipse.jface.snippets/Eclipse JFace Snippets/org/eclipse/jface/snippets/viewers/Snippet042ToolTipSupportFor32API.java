...
public class Snippet042ToolTipSupportFor32API {
	...
	private static class ToolTipSupport extends DefaultToolTip {
		...
		protected ToolTipSupport(ColumnViewer<MyModel, List<MyModel>> viewer,
		...
		protected Composite createToolTipContentArea(Event event,
			...
			b.setImage(((ITableLabelProvider<MyModel>) viewer
					.getLabelProvider()).getColumnImage(
					(MyModel) cell.getData(), cell.index));
