...
public class Snippet052DouleClickCellEditor {
	...
	private TableViewerColumn<MyModel, List<MyModel>> createColumnFor(final TableViewer<MyModel, List<MyModel>> viewer,
			String label, String property) {
		TableViewerColumn<MyModel, List<MyModel>> column;
		column = new TableViewerColumn<MyModel, List<MyModel>>(viewer, SWT.NONE);
