...
public class SimpleVirtualLazyTreeViewerTest extends ViewerTestCase {
	...
	private class LazyTreeContentProvider implements
			ILazyTreeContentProvider<String, String> {
		/**
		 *
		 */
		...
		@Override
		public void inputChanged(Viewer<? extends String> viewer,
	...
	public void testCreation() {
		if (disableTestsBug347491)
			return;
		if (!setDataCalled) {
			System.err.println("SWT.SetData is not received. Cancelled test "
					+ getName());
			return;
		}
		processEvents();
